...
void ASoulLikeCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(AttackAction, ETriggerEvent::Started, this, &ASoulLikeCharacter::Attack);
...
void ASoulLikeCharacter::Attack(const FInputActionValue& Value)
{
